...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'symfony', 'user' => 'root', 'password' => 'Gokuzit0_5551', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_f54a71515da618312fc91ac915073f106a5032cefd549fd91ea6a1ca533c8d4e');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_f54a71515da618312fc91ac915073f106a5032cefd549fd91ea6a1ca533c8d4e');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_f54a71515da618312fc91ac915073f106a5032cefd549fd91ea6a1ca533c8d4e');
        ...
        $d->setProxyDir('/var/www/html/symfony/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/var/www/html/symfony/app');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/var/www/html/symfony/src/Blogger/BlogBundle/Resources/views', 'BloggerBlog');
        $instance->addPath('/var/www/html/symfony/src/Acme/DemoBundle/Resources/views', 'AcmeDemo');
