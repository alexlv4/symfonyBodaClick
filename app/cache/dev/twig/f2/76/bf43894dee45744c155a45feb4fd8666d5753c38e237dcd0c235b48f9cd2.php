...
class __TwigTemplate_f276bf43894dee45744c155a45feb4fd8666d5753c38e237dcd0c235b48f9cd2 extends Twig_Template
{
    ...
    <div id=\"content\">
        ...
        if ($this->getContext($context, "profile")) {
            ...
            echo "\">View last 10</a>
                            ...
                            ";
            // line 18
            echo twig_escape_filter($this->env, strtoupper($this->getAttribute($this->getContext($context, "profile"), "method")), "html", null, true);
            echo "
                            ";
            // line 19
            if (twig_in_filter(strtoupper($this->getAttribute($this->getContext($context, "profile"), "method")), array(0 => "GET", 1 => "HEAD"))) {
                // line 20
                echo "                                <a href=\"";
